...
(function() {
 var loadPackage = function(metadata) {
    ...
    var PACKAGE_NAME = 'endlessrun1.data';
    var REMOTE_PACKAGE_BASE = 'endlessrun1.data';
    ...
    var REMOTE_PACKAGE_NAME = typeof Module['locateFile'] === 'function' ?
      ...
      var REMOTE_PACKAGE_SIZE = 3486083;
      var PACKAGE_UUID = 'b884e101-9c7c-472d-b70f-7a4a2ef12ab2';
...
Module['FS_createPath']('/Managed/mono', '2.0', true, true);
    ...
    DataRequest.prototype = {
      ...
      new DataRequest(0, 50, 0, 0).open('GET', '/PlayerConnectionConfigFile');
    new DataRequest(50, 709754, 0, 0).open('GET', '/data.unity3d');
    new DataRequest(709754, 709773, 0, 0).open('GET', '/methods_pointedto_by_uievents.xml');
    new DataRequest(709773, 712814, 0, 0).open('GET', '/preserved_derived_types.xml');
    new DataRequest(712814, 2583486, 0, 0).open('GET', '/Il2CppData/Metadata/global-metadata.dat');
    new DataRequest(2583486, 3458458, 0, 0).open('GET', '/Resources/unity_default_resources');
    new DataRequest(3458458, 3486083, 0, 0).open('GET', '/Managed/mono/2.0/machine.config');
    ...
    function processPackageData(arrayBuffer) {
      ...
      DataRequest.prototype.byteArray = byteArray;
          ...
          Module['removeRunDependency']('datafile_endlessrun1.data');

    };
    Module['addRunDependency']('datafile_endlessrun1.data');
